...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Ola 3D -- Luan!", nullptr, nullptr);
...
static_cast<GLfloat>(WIDTH) / static_cast<GLfloat>(HEIGHT), 0.1f, 100.0f);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glLineWidth(10); // Está depreciada
		glPointSize(20); // Está depreciada

		float angle = (GLfloat)glfwGetTime();

		model = glm::mat4(1); // Matrix Identidade
		if (rotateX)
		{
